...
model_paths = {
    "SSP with Augmentation TL only": "./models/BERT-SSP-DA-POS/BERTPOS_tl_only",
    "SOP with Augmentation": "./models/BERT-SOP-DA-POS/BERTPOS_tl",
    "SSP without Augmentation": "./models/BERT-SSP-POS/BERTPOS_tl",
    "SOP without Augmentation": "./models/BERT-SOP-POS/BERTPOS_tl",
    "Baseline": "./models/BERT-NSP-POS/BERTPOS_tl",
    "Baseline with Augmentation": "./models/BERT-NSP-DA-POS/BERTPOS_tl_only"
}
