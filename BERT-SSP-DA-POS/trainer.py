...
output_file = "./BERT-SSP-DA-POS/predictions_output.txt"
args_directory = "./BERT-SSP-DA-POS/checkpoint"
save_path = "./BERT-SSP-DA-POS/confusion_matrix.png"
epoch_number = 25
save_model = "./BERT-SSP-DA-POS/BERTPOS"
