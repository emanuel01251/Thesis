...
training_args = TrainingArguments(
    output_dir="./models/BERT-SSP/output_model_continual_2",  # Directory where the model checkpoints will be saved
    num_train_epochs=10,
...
print(trainer.model)
exit()
checkpoint_dir = "./models/BERT-SSP/output_model_tagalog/checkpoint-65000"  # Replace with the correct checkpoint step
