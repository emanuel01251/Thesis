...
output_file = "./models/BERT-SOP-DA-POS/predictions_output_tl.txt"
output_file_sentence = "./models/BERT-SOP-DA-POS/sentence_predictions_output_tl.txt"
args_directory = "./models/BERT-SOP-DA-POS/checkpoint_tl"
save_path = "./models/BERT-SOP-DA-POS/confusion_matrix_tl.png"
epoch_number = 5
save_model = "./models/BERT-SOP-DA-POS/BERTPOS_tl"
