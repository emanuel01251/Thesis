...
output_file = "./BERT-NSP-POS/predictions_output_tl.txt"
output_file_sentence = "./BERT-NSP-POS/sentence_predictions_output_tl.txt"
args_directory = "./BERT-NSP-POS/checkpoint_tl"
save_path = "./BERT-NSP-POS/confusion_matrix_tl.png"
epoch_number = 5
save_model = "./BERT-NSP-POS/BERTPOS_tl"
