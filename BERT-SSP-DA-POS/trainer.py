...
output_file = "./BERT-SSP-DA-POS/predictions_output_tl_only.txt"
output_file_sentence = "./BERT-SSP-DA-POS/sentence_predictions_output_tl_only.txt"
args_directory = "./BERT-SSP-DA-POS/checkpoint_tl_only"
save_path = "./BERT-SSP-DA-POS/confusion_matrix_tl_only.png"
epoch_number = 5
save_model = "./BERT-SSP-DA-POS/BERTPOS_tl_only"
