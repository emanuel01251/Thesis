...
bert_model = "./BERT-SSP/output_model_tagalog_hiligaynon2/checkpoint-117000/"
output_file = "./BERT-SSP-POS/predictions_output.txt"
args_directory = "./BERT-SSP-POS/checkpoint"
save_path = "./BERT-SSP-POS/confusion_matrix.png"
epoch_number = 25
save_model = "./BERT-SSP-POS/BERTPOS"
