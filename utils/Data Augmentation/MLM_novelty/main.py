...
model_checkpoint = "./models/BERT-SSP-POS/BERTPOS_merged_less_2"
...
# Usage example:
ssp_model_path = "./models/BERT-SSP/output_model_merged/checkpoint-331500/"
pos_tagger_path = "./models/BERT-SSP-POS/BERTPOS_merged_less_2"
