...
output_file = "./models/BERT-NSP-DA-POS/predictions_output_tl_only_only.txt"
output_file_sentence = "./models/BERT-NSP-DA-POS/sentence_predictions_output_tl_only.txt"
args_directory = "./models/BERT-NSP-DA-POS/checkpoint_tl_only"
save_path = "./models/BERT-NSP-DA-POS/confusion_matrix_tl_only.png"
epoch_number = 5
save_model = "./models/BERT-NSP-DA-POS/BERTPOS_tl_only"
