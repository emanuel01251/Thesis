...
output_file = "./BERT-SSP-POS/predictions_output_tl.txt"
output_file_sentence = "./BERT-SSP-POS/sentence_predictions_output_tl.txt"
args_directory = "./BERT-SSP-POS/checkpoint_tl"
save_path = "./BERT-SSP-POS/confusion_matrix_tl.png"
epoch_number = 5
save_model = "./BERT-SSP-POS/BERTPOS_tl"
