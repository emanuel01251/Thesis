...
training_args = TrainingArguments(
    output_dir="./models/BERT-SSP/output_model_merged",  # Directory where the model checkpoints will be saved
    num_train_epochs=30,
...
checkpoint_dir = "./models/BERT-SSP/output_model_merged/checkpoint-221000"  # Replace with the correct checkpoint step
