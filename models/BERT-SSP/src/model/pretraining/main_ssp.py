...
training_args = TrainingArguments(
    output_dir="./models/BERT-SSP/output_model_hiligaynon",  # Directory where the model checkpoints will be saved
    num_train_epochs=25,
...
checkpoint_dir = "./models/BERT-SSP/output_model_tagalog/checkpoint-478000"  # Replace with the correct checkpoint step
