...
train_corpus = "./models/BERT-NSP-POS/corpus/train-set.txt"
val_corpus = "./models/BERT-NSP-POS/corpus/eval-set.txt"
...
output_file = "./models/BERT-NSP-POS/predictions_output_syke.txt"
output_file_sentence = "./models/BERT-NSP-POS/sentence_predictions_output_syke.txt"
args_directory = "./models/BERT-NSP-POS/checkpoint_syke"
save_path = "./models/BERT-NSP-POS/confusion_matrix_syke.png"
epoch_number = 5
save_model = "./models/BERT-NSP-POS/BERTPOS_syke"
