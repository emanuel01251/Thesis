...
output_file = "./models/BERT-SSP-POS/predictions_output_tl.txt"
output_file_sentence = "./models/BERT-SSP-POS/sentence_predictions_output_tl.txt"
args_directory = "./models/BERT-SSP-POS/checkpoint_tl"
save_path = "./models/BERT-SSP-POS/confusion_matrix_tl.png"
epoch_number = 5
save_model = "./models/BERT-SSP-POS/BERTPOS_tl"
