...
output_file = "./BERT-SOP-POS/predictions_output.txt"
args_directory = "./BERT-SOP-POS/checkpoint"
save_path = "./BERT-SOP-POS/confusion_matrix.png"
epoch_number = 25
save_model = "./BERT-SOP-POS/BERTPOS"
