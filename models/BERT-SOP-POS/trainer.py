...
train_corpus = "./Dataset/Labeled Corpus/tl-hil-train-set-less-tagset.txt"
...
bert_model = "./models/BERT-SOP/output_model_merged/checkpoint-197500/"
output_file = "./models/BERT-SOP-POS/predictions_output_tl.txt"
output_file_sentence = "./models/BERT-SOP-POS/sentence_predictions_output_tl.txt"
args_directory = "./models/BERT-SOP-POS/checkpoint_tl"
save_path = "./models/BERT-SOP-POS/confusion_matrix_tl.png"
epoch_number = 5
save_model = "./models/BERT-SOP-POS/BERTPOS_tl"
