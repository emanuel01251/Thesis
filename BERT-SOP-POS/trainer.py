...
output_file = "./BERT-SOP-POS/predictions_output_tl.txt"
output_file_sentence = "./BERT-SOP-POS/sentence_predictions_output_tl.txt"
args_directory = "./BERT-SOP-POS/checkpoint_tl"
save_path = "./BERT-SOP-POS/confusion_matrix_tl.png"
epoch_number = 5
save_model = "./BERT-SOP-POS/BERTPOS_tl"
