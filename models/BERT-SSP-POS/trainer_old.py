...
bert_model = "./models/BERT-SSP/output_model_tagalog_hiligaynon2/checkpoint-117000/"

vocab_file = "./models/BERT-SSP/tokenizer-corpus-hiligaynon/uncased-vocab.txt"
merges_file = "./models/BERT-SSP/tokenizer-corpus/cased.json"
...
args = TrainingArguments(
    "./models/BERT-SSP-POS/checkpoint",
...
""" checkpoint_dir = "./models/BERT-SSP-POS/checkpoint/checkpoint-1530" """
training = trainer.train()
print(training)
results = trainer.evaluate()
print("Evaluation: ", results)
trainer.save_model("./models/BERT-SSP-POS/BERTPOS")
print(results)
