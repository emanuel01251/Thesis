...
output_file = "./models/BERT-SSP-POS/predictions_output_merged_less_test.txt"
args_directory = "./models/BERT-SSP-POS/checkpoint_merged_less_test"
save_path = "./models/BERT-SSP-POS/confusion_matrix_merged_less_test.png"
epoch_number = 2
save_model = "./models/BERT-SSP-POS/BERTPOS_merged_less_test"
