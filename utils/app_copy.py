...
model_paths = {
    "SSP with Augmentation": "./models/BERT-SSP-DA-POS/BERTPOS_test",
    "SOP with Augmentation": "./models/BERT-SOP-DA-POS/BERTPOS_test",
    "SSP without Augmentation": "./models/BERT-SSP-POS/BERTPOS_test",
    "SOP without Augmentation": "./models/BERT-SOP-POS/BERTPOS_test",
    "NSP baseline": "./models/BERT-NSP-POS/BERTPOS_test"
}
