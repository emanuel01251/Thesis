...
output_file = "./models/BERT-NSP-POS/predictions_output_tl.txt"
output_file_sentence = "./models/BERT-NSP-POS/sentence_predictions_output_tl.txt"
args_directory = "./models/BERT-NSP-POS/checkpoint_tl"
save_path = "./models/BERT-NSP-POS/confusion_matrix_tl.png"
epoch_number = 5
save_model = "./models/BERT-NSP-POS/BERTPOS_tl"
