...
# Input Files:
#train_corpus = "./Dataset/Labeled Corpus/augmented_dataset.txt"
#val_corpus = "./Dataset/Labeled Corpus/hil-eval-set-less-tagset.txt"
train_corpus = "./Dataset/Labeled Corpus/tl_only_augmented_dataset_90.txt"
...
bert_model = "./models/BERT-SSP/output_model_merged/checkpoint-331500/"
output_file = "./models/BERT-SSP-DA-POS/predictions_output_tl_only.txt"
output_file_sentence = "./models/BERT-SSP-DA-POS/sentence_predictions_output_tl_only.txt"
args_directory = "./models/BERT-SSP-DA-POS/checkpoint_tl_only"
save_path = "./models/BERT-SSP-DA-POS/confusion_matrix_tl_only.png"
epoch_number = 5
save_model = "./models/BERT-SSP-DA-POS/BERTPOS_tl_only"
