...
# Input Files:
""" train_corpus = "./models/BERT-SOP-POS/corpus/train-set.txt"
val_corpus = "./models/BERT-SOP-POS/corpus/eval-set.txt" """
""" train_corpus = "./Dataset/Labeled Corpus/train-set.txt"
val_corpus = "./Dataset/Labeled Corpus/eval-set.txt" """
train_corpus = "./Dataset/Labeled Corpus/hil-train-set-new.txt"
val_corpus = "./Dataset/Labeled Corpus/hil-eval-set-new.txt"

""" vocab_file = "./models/BERT-SSP/tokenizer-corpus-tagalog/uncased-vocab.txt" """
""" vocab_file = "./models/BERT-SSP/tokenizer-corpus-hiligaynon/uncased-vocab.txt" """
""" vocab_file = "./models/BERT-SSP/tokenizer-corpus-hiligaynon-2/uncased-vocab.txt" """
""" vocab_file = "./models/BERT-SSP/tokenizer-corpus-hiligaynon/uncased-vocab.txt" """
...
bert_model = "./models/BERT-SOP/output_model_merged/checkpoint-19500/"
output_file = "./models/BERT-SOP-POS/predictions_output_merged_2.txt"
args_directory = "./models/BERT-SOP-POS/checkpoint_merged_2"
save_path = "./models/BERT-SOP-POS/confusion_matrix_merged_2.png"
epoch_number = 25
save_model = "./models/BERT-SOP-POS/BERTPOS_merged_2"
